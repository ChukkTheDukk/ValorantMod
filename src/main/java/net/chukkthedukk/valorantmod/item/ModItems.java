...
import net.chukkthedukk.valorantmod.item.custom.TooltipItem;
...
public class ModItems {
    ...
    public static final Item CLASSIC_STANDARD = registerItem("classic_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.CLASSIC).maxCount(1)));
    public static final Item SHORTY_STANDARD = registerItem("shorty_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.SHORTY).maxCount(1)));
    public static final Item FRENZY_STANDARD = registerItem("frenzy_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.FRENZY).maxCount(1)));
    public static final Item GHOST_STANDARD = registerItem("ghost_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.GHOST).maxCount(1)));
    public static final Item SHERIFF_STANDARD = registerItem("sheriff_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.SHERIFF).maxCount(1)));
    public static final Item STINGER_STANDARD = registerItem("stinger_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.STINGER).maxCount(1)));
    public static final Item SPECTRE_STANDARD = registerItem("spectre_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.SPECTRE).maxCount(1)));
    public static final Item BUCKY_STANDARD = registerItem("bucky_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.BUCKY).maxCount(1)));
    public static final Item JUDGE_STANDARD = registerItem("judge_standard",
            new TooltipItem(new FabricItemSettings().group(ModItemGroup.JUDGE).maxCount(1)));
